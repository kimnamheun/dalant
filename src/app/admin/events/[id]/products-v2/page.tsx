...
export default function EventProductsV2Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <NavHeader title="상품 관리 (개선판)" backHref="/admin/events" />
      ...
      <main className="p-4 max-w-3xl mx-auto space-y-4 animate-fade-in">
        ...
        <div className="text-center pt-2">
          <Link href={`/admin/events/${eventId}/products`} className="text-xs text-muted-foreground hover:text-foreground">
            ← 기존 상품 관리 페이지로 이동
          </Link>
        </div>
      </main>
